...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('username', 'name', 'role', 'is_staff', 'is_superuser')
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('username', 'name', 'role', 'password', 'is_active', 'is_superuser')
...
class CustomeDatePickerWidget(forms.DateInput):
...
class PastCustomDatePickerWidget(CustomeDatePickerWidget):
